...
<link rel="shortcut icon" href="{{ asset('images/favicon.svg') }}">
   <body>
       <nav class="navbar navbar-expand-lg p-0">
           <a class="navbar-brand" href="@yield('link')">Data Entry</a>
               ...
               <ul class="navbar-nav mr-auto">
                   ...
                   <li class="nav-item">
                       <a class="button3 navbar-buttons" href="#" style="text-decoration: none;">
                           ...
                           </svg> Add New Products</a>
                   </li>
                   <li class="nav-item">
                       <a class="button3 navbar-buttons" href="{{route('create.user')}}" style="text-decoration: none;">
                           <svg class="input-icon1 mb-1" xmlns="http://www.w3.org/2000/svg"
                               viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                               <path
                                   d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l144 0 0 144c0 17.7 14.3 32 32 32s32-14.3 32-32l0-144 144 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-144 0 0-144z" />
           ...
           <div class="btn-group mr-4">
               ...
               <div class="dropdown-menu">
                  ...
                  <div class="buttons">
                   <a class="button4" href="">Products List</a>
               </div>
               <div class="buttons">
