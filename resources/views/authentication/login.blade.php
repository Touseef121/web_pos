...
@section('content')
    ...
    <body style="background-image: url(images/login-background.jpg); background-size:cover; ">
        <div class="container login-form">
            <form class="form col-md-6" action="{{ route('user.login') }}" method="POST">
                @csrf
                <h3 id="heading">Login POS</h3>
                @if (session('error'))
                ...
                <div class="field">
                    ...
                    <input autocomplete="off" placeholder="Username" class="input-field" type="text" name="user_name">
                </div>
                <div class="field">
                    <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" viewBox="0 0 16 16">
                ...
                <div class="row" style="display: flex; justify-content:center;">
                    <div class="btn">
                        <a href="/" style="text-decoration: none;" class="button1">
